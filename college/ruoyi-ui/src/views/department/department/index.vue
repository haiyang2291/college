    ...
    <el-table v-loading="loading" :data="departmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column type="expand" align="center" prop="introduction">
        <template v-slot:="scope">
          <el-card v-html="scope.row.introduction"></el-card>
        </template>
      </el-table-column>
      <el-table-column label="学院名称" align="center" prop="name" />
      <el-table-column label="所属高校" align="center" prop="collegeId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="高校名称" prop="collegeId">
          <el-select style="width: 100%"v-model="form.collegeId" placeholder="请选择高校名称" clearable>
            <el-option
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除院系管理编号为"' + ids + '"的数据项？').then(function() {
