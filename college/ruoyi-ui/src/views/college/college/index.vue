<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="collegeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="高校名称" align="center" prop="name" />
      <el-table-column label="高校地址" align="center" prop="address" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="高校地址" prop="address">
          <el-input v-model="form.address" placeholder="请输入高校地址" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        address: [
          { required: true, message: "高校地址不能为空", trigger: "blur" }
        ],
        introduction: [
          { required: true, message: "高校简介不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除高校管理编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('college/college/export', {
        ...this.queryParams
